                ...
                <div id="content">
                    ...
                    <div class="container-fluid" id="container-wrapper">
                        <div class="d-sm-flex align-items-center justify-content-between mb-4">
                            <h1 class="h3 mb-0 text-gray-800">Master Penilaian Administratif</h1>
                            <ol class="breadcrumb">
                                            ...
                                            <table class="table align-items-center table-flush" id="dataTable">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="{{ route('penilaianadministratif.edit', $penilaian->id) }}" class="btn btn-sm btn-primary">Edit</a>

<ul class="navbar-nav sidebar sidebar-light accordion" id="accordionSidebar">
    ...
    <li class="nav-item">
        ...
        @if (request()->is('admin/bidang') || request()->is('admin/buttons') || request()->is('admin/dropdowns') || request()->is('admin/modals') || request()->is('admin/popovers') || request()->is('admin/progress-bars'))
        show
        @endif" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <!-- <a class="collapse-item{{ request()->is('admin/alert') ? ' active' : '' }}" href="{{ route('alerts') }}">Alerts</a>
